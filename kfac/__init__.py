...
from kfac.kfac_preconditioner_inv_mpd import KFAC as KFAC_INV_MPD
...
from kfac.kfac_preconditioner_inv_subsampling import KFAC as KFAC_INV_SUBSAMPLING
...
kfac_mappers = {
    ...
    'inverse_subsampling': KFAC_INV_SUBSAMPLING,
