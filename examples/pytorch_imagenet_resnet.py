...
def initialize():
    ...
    logfile = './logs/timing_imagenet_resnet50_kfac{}_gpu{}_bs{}_{}_ep_{}.log'.format(args.kfac_update_freq, hvd.size(), args.batch_size, args.kfac_name, args.exclude_parts)
