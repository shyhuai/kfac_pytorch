...
def read_multiple_speeds():
    ...
    dnn='resnet50';density=1;bs=64;lr=1.2;nw=64
    ...
    for idx, ep in enumerate(exclude_parts):
        ...
        fn = '%s/timing_imagenet_%s_kfac1_gpu%d_bs%d_inverse_ep_%s.log' % (LOGHOME, dnn, nw, bs, exclude_part)
...
if __name__ == '__main__':
    #logfile = 'logs/timing_imagenet_resnet50_kfac0_gpu16_bs64_inverse_ep_\'\'.log'
